...
Route::group(['prefix' => $prefix, 'namespace' => 'Admin', 'middleware' => ['web', 'admin_locale']], function () use ($prefix) {
    ...
    // ================ get-products-by-type : get products according to "product_type" selectbox value  ================
    Route::get('get-products-by-type', [ProductsController::class, 'getProductsByType'])
            ->name('admin.getProductsByType');
    // Captcha
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'staffs'], function ()
        {
            ...
            // ============ Start : Excel ============
            Route::post('/import', [UserController::class, 'importStaffs'])->name('staffs.import');
            Route::get('/export', 'UserController@exportExcelStaffs')->name('staffs.export');
            // ============ End : Excel ============
        });
        ...
        Route::group(['prefix' => 'students'], function () {
            ...
            // ============ Start : Excel ============
            Route::post('/import','UserController@importExcelStudents')->name('students.import');
        ...
        Route::group(['prefix' => 'instructors'], function () {
            ...
            Route::post('/import','UserController@importExcelInstructors')->name('instructors.import');
            // ============ End : Excel ============
        });
        ...
        Route::group(['prefix' => 'organizations'], function () {
            ...
            Route::post('/import','UserController@importExcelOrganizations')->name('organizations.import');
            // ============ End : Excel ============
        });
        ...
        Route::group(['prefix' => 'users'], function () {
            ...
            // ++++++++++++++++ download users(staff , organization and instructor) excel template +++++++++++++
            // Route::get('/download-template', [UserController::class, 'downloadTemplateUsers'])
            //             ->name('users.download.template');
              // ++++++++++++++++ 1- download organization excel template +++++++++++++
            Route::get('/download-template/organization', [UserController::class, 'downloadTemplateOrganizations'])
                        ->name('organization.download.template');
            // ++++++++++++++++ 2-download staff excel template +++++++++++++
            Route::get('/download-template/staff', [UserController::class, 'downloadTemplateStaff'])
                        ->name('staff.download.template');
            // ++++++++++++++++ download students excel template +++++++++++++
            Route::get('/download-template/student', [UserController::class, 'downloadTemplateStudents'])
                        ->name('students.download.template');
            // ++++++++++++++++ download instructor excel template +++++++++++++
            Route::get('/download-template/instructor', [UserController::class, 'downloadTemplateInstructors'])
                        ->name('instructor.download.template');
        ...
        Route::group(['prefix' => 'webinars'], function () {
            ...
            Route::get('/template/download', [WebinarController::class, 'downloadTemplate'])->name('webinars.excel.template.download');
            // ++++++++++++++ importExcel() : import excel sheet ++++++++++++++
            Route::post('/import', [WebinarController::class, 'importExcel'])->name('webinars.excel.import');
        ...
        Route::group(['prefix' => 'reviews'], function () {
            ...
            Route::get('/reviews/export', 'ReviewsController@export')->name('admin.reviews.export');
            Route::post('/import', 'ReviewsController@import')->name('admin.reviews.import');
            Route::get('/download-template', 'ReviewsController@downloadTemplate')->name('admin.reviews.download-template');
        ...
        Route::group(['prefix' => 'blog'], function () {
            ...
            Route::get('/blogs/export', 'BlogController@export')->name('admin.blogs.export');
            Route::post('/import/blogs', 'BlogController@import')->name('admin.blogs.import');
            Route::get('/download-blogs-template', 'BlogController@downloadTemplate')->name('admin.blogs.download-template');
        ...
        Route::group(['prefix' => 'financial'], function () {
            ...
            // +++++++++++++++++++++++++ end   : course discount +++++++++++++++++++++++++
            // +++++++++++++++++++++++++ start : special_offer_product_discounts +++++++++++++++++++++++++
            Route::group(['prefix' => 'special_offer_product_discounts','as'=>'special_offer_product_discounts.'], function () {
                Route::get('/'              , 'SpecialOfferProductDiscountController@index')->name('list');
                Route::get('/new'           , 'SpecialOfferProductDiscountController@create')->name('new');
                Route::post('/store'        , 'SpecialOfferProductDiscountController@store')->name('store');
                Route::get('/{id}/edit'     , 'SpecialOfferProductDiscountController@edit')->name('edit');
                Route::post('/{id}/update'  , 'SpecialOfferProductDiscountController@update')->name('update');
                Route::get('/{id}/delete'   , 'SpecialOfferProductDiscountController@destroy')->name('delete');
            });
            // +++++++++++++++++++++++++ end : special_offer_product_discounts +++++++++++++++++++++++++
        ...
        Route::group(['prefix' => 'settings'], function () {
            ...
            // ++++++++++++ settings : language_over_ip +++++++++++++++++
            Route::group(['prefix' => 'language_over_ip'], function () 
            {
                Route::post('/store', 'SettingsController@storeLanguageOverIp');
                Route::get('/{mapping_key}/edit', 'SettingsController@editLanguageOverIp');
                // [[[[[[[[[[[[[[[[[ Country Mapping ]]]]]]]]]]]]]]]]]]]
                // Store "Country Mapping" without reload page : "AJAX endpoint"
                Route::post('/store-mapping', 'SettingsController@storeMapping'); 
                // Delete "Country Mapping" without reload page : "AJAX endpoint"
                Route::get('/{mappingKey}/delete', 'SettingsController@deleteMapping');
                // [[[[[[[[[[[[[[[[[ Popup ]]]]]]]]]]]]]]]]]]]
                // Store "Popup" without reload page : "AJAX endpoint"
                Route::post('/store-popup', 'SettingsController@storePopupSetting');
            });
        ...
        Route::group(['prefix' => 'testimonials'], function () {
            ...
            Route::get('/{id}/delete', 'TestimonialsController@delete');
             // New Routes for Importing & Downloading Template
            Route::post('/import', 'TestimonialsController@import')->name('admin.testimonials.import');
            Route::get('/download-template', 'TestimonialsController@downloadTemplate')->name('admin.testimonials.download-template');
            Route::get('/testimonials/export', 'TestimonialsController@export')->name('admin.testimonials.export');
        });
        ...
        Route::group(['prefix' => 'store', 'namespace' => 'Store'], function () {
            ...
            Route::group(['prefix' => 'products'], function () {
                ...
                // ++++++++++++++ downloadTemplate() : download excel Template ++++++++++++++
                Route::get('/template/download', [ProductsController::class, 'downloadTemplate'])->name('products.excel.template.download');
                // ++++++++++++++ importExcel() : import excel sheet ++++++++++++++
                Route::post('/import', [ProductsController::class, 'importExcel'])->name('products.excel.import');
                // Save Product Variant
                Route::post('/save-product-variants', 'ProductsController@save_product_variants')->name('save_product_variants');
                Route::get('/delete-product-variant/{id}', 'ProductsController@delete_product_variants')->name('delete_product_variants');
                Route::post('/update-product-variants', 'ProductsController@update_product_variants')->name('update_product_variants');
            ...
            Route::group(['prefix' => 'specifications'], function () {
                ...
                Route::post('/save-new-value-variant', 'SpecificationController@setMultiValuesAjax')->name('save_new_value_variant');
            });
            ...
            Route::group(['prefix' => 'reviews'], function () {
                ...
                Route::get('/{id}/reply', 'ReviewsController@reply');
                Route::get('/{id}/delete', 'ReviewsController@delete');
                Route::get('/reviews/export', 'ReviewsController@export')->name('admin.products_reviews.export');
                Route::post('/import', 'ReviewsController@import')->name('admin.products_reviews.import');
                Route::get('/download-template', 'ReviewsController@downloadTemplate')->name('admin.products_reviews.download-template');
        ...
        Route::group(['prefix' => 'forums'], function () {
            ...
            Route::post('/search', 'ForumController@search');
              // New Routes for Importing & Downloading Template
              Route::post('/import-forums', 'ForumController@import')->name('admin.forums.import');
              Route::get('/download-template', 'ForumController@downloadTemplate')->name('admin.forums.download-template');
              Route::get('/forums/export', 'ForumController@export')->name('admin.forums.export');
        ...
        Route::group(['prefix' => 'featured-topics'], function () {
            ...
            Route::post('/import', 'FeaturedTopicsController@import')->name('admin.featured-topics.import');
            Route::get('/download-template', 'FeaturedTopicsController@downloadTemplate')->name('admin.featured-topics.download-template');
            Route::get('/export', 'FeaturedTopicsController@export')->name('admin.featured-topics.export');
        });
        ...
        Route::group(['prefix' => 'recommended-topics'], function () {
            ...
            Route::get('/{id}/delete', 'RecommendedTopicsController@destroy');
             // Import & Export Routes
             Route::post('/import', 'RecommendedTopicsController@import')->name('admin.recommended-topics.import');
             Route::get('/download-template', 'RecommendedTopicsController@downloadTemplate')->name('admin.recommended-topics.download-template');
             Route::get('/export', 'RecommendedTopicsController@export')->name('admin.recommended-topics.export');
        });
...
Route::get('/get-specifications/{id}', [FilterController::class,'getSpecifications'])->name('get_category_specifications');
