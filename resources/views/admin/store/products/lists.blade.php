...
@section('content')
    ...
    @endif
    {{-- +++++++++++++++++++++ Import Excel Form +++++++++++++++++++++ --}}
    <form method="post" action="{{ route('products.excel.import') }}" enctype="multipart/form-data" class="mt-3" id="excelImportForm">
        {{ csrf_field() }}
        <section>
            <h4 class="section-title after-line">
                {{ trans('product.import_product_from_excel') }}
            </h4>
            <div class="row">
                <div class="col-8">
                    <div class="form-group mt-15">
                        <label class="input-label">
                            {{ trans('product.upload_excel_file') }}
                        </label>
                        <input type="file" name="file" class="form-control @error('excel_file') is-invalid @enderror" accept=".xlsx,.xls">
                    </div>
                </div>
                <div class="col-4">
                    <button type="submit" class="btn btn-primary" style="margin-top:35px !important;">
                        {{ trans('product.submit_excel') }}
                    </button>
                </div>
            </div>
        </section>
    ...
    @include('admin.store.products.excel_instructions')
@endsection
