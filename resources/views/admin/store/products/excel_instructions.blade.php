    ...
    <div class="col-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{ trans('product.type') }}
                                <span class="badge badge-success">{{ trans('product.required') }}</span></td>
                            <td>{{ trans('product.type_instruction') }}</td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>{{ trans('product.locale') }}
                                <span class="badge badge-success">{{ trans('product.required') }}</span></td>
                        ...
                        <tr>
                            ...
                            <td>{{ trans('product.title') }}
                                <span class="badge badge-success">{{ trans('product.required') }}</span>
                            </td>
                            <td>{{ trans('product.title_instruction') }}</td>
                        </tr>
                        <tr>
                            <td>5</td>
                            <td>{{ trans('product.category_id') }}
                                <span class="badge badge-info">{{ trans('product.optional') }}</span>
                            </td>
                            <td>{{ trans('product.category_id_instruction') }}</td>
                        </tr>
                        <tr>
                            <td>6</td>
                            <td>{{ trans('product.price') }}
                                <span class="badge badge-info">{{ trans('product.optional') }}</span>
                            </td>
                        ...
                        <tr>
                            <td>8</td>
                            <td>{{ trans('product.unlimited_inventory') }}
                                <span class="badge badge-success">{{ trans('product.required') }}</span>
                            </td>
                        ...
                        <tr>
                            <td>11</td>
                            <td>{{ trans('product.inventory_warning') }}
                                <span class="badge badge-info">{{ trans('product.optional') }}</span>
                            </td>
                        ...
                        <tr>
                            <td>13</td>
                            <td>{{ trans('product.delivery_estimated_time') }}
                                <span class="badge badge-info">{{ trans('product.optional') }}</span>
                            </td>
                        ...
                        <tr>
                            <td>14</td>
                            <td>{{ trans('product.message_for_reviewer') }}
                                <span class="badge badge-info">{{ trans('product.optional') }}</span>
                            </td>
                        ...
                        <tr>
                            <td>16</td>
                            <td>{{ trans('product.commission_type') }}
                                <span class="badge badge-success">{{ trans('product.required') }}</span>
                            </td>
                        ...
                        <tr>
                            <td>19</td>
                            <td>{{ trans('product.seo_description') }}
                                <span class="badge badge-info">{{ trans('product.optional') }}</span>
                            </td>
                        ...
                        <tr>
                            <td>24</td>
                            <td>{{ trans('product.filter_options') }}
                                <span class="badge badge-info">{{ trans('product.optional') }}</span>
                            </td>
                ...
                <div class="mt-3">
                    <a href="{{ route('products.excel.template.download') }}" class="btn btn-primary">
