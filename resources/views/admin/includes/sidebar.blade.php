<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @can('admin_product_discount')
                <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/financial/special_offer_product_discounts*', false))) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fa fa-fire"></i>
                    ...
                    <ul class="dropdown-menu">
                        {{-- ======= list ======= --}}
                        @can('admin_product_discount_list')
                            <li class="{{ (request()->is(getAdminPanelUrl('/financial/special_offer_product_discounts', false))) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/special_offer_product_discounts">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan
                        {{-- ======= new ======= --}}
                        @can('admin_product_discount_create')
                            <li class="{{ (request()->is(getAdminPanelUrl('/financial/special_offer_product_discounts/new', false))) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/special_offer_product_discounts/new">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
