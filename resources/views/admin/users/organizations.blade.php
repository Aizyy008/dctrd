...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{ route('organizations.import') }}" enctype="multipart/form-data" class="mt-3" id="excelImportForm">
                {{ csrf_field() }}
                <section>
                ...
                <div class="mt-3">
                    <a href="{{ route('organization.download.template') }}" class="btn btn-success btn-sm">
