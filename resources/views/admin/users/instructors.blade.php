...
@section('content')
    ...
    <section class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{ route('instructors.import') }}" enctype="multipart/form-data" class="mt-3" id="excelImportForm">
                {{ csrf_field() }}
                <section>
                ...
                <div class="mt-3">
                    <a href="{{ route('instructor.download.template') }}" class="btn btn-success btn-sm">
