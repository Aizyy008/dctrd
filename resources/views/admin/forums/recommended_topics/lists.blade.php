...
@section('content')
    <section class="section">
        ...
        <a href="{{route('admin.recommended-topics.export')}}" class="btn btn-success mb-3">{{trans('admin/main.bulk_export')}}</a>
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.recommended-topics.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mt-5">
                            <a href="{{ route('admin.recommended-topics.download-template') }}" class="btn btn-success">{{ trans('admin/main.download_template') }}</a>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ trans('admin/main.recommended_topics_title_description') }}</td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td>
