...
'recommended_topics_title_description' => 'Enter the Title Of Recommended Topic',
'topic_id_description' => 'Enter the topic_id from https://www.yrreadybiz.com/admin/forums by press on Topics button',
'topic_id' => 'Topic ID',
'group_id_description' => 'Enter group_id from https://www.yrreadybiz.com/public/admin/users/groups',
'role_id_description' => 'Enter role_id from https://www.yrreadybiz.com/public/admin/roles',
'group_id' => 'Group ID',
'role_id' => 'Role ID',
'forum_description' => 'Enter the forum description',
'forum_status_description' => 'Enter either "disabled" or "active".',
'forum_closed_description' => 'Enter "1" to close the forum or "0" to keep it open.',
'forum_posts_description' => 'Enter the number of posts in the forum.',
'forum_topics_description' => 'Enter the number of topics in the forum.',
'sub_forums_description' => 'Enter the parent forum ID if this is a sub-forum, or leave it NULL for a main forum.',
'forum_title_description' => 'Enter the forum title.',
'icon_description' => 'Enter the icon URL By Download the Excel file and write like the icon value like : /store/1/default_images/forums/icons/makeup.png',
'topics' => 'Topics',
'sub-forums' => 'Sub Forums',
'bolgs_status_description' => 'Enter either "pending" or "publish". publish value for Active and  pending value for Pending.',
'author_description' => 'Enter the ID of the author from https://www.yrreadybiz.com/admin/staffs',
'category_description' => 'Enter the ID of the blog_category from https://www.yrreadybiz.com/admin/blog/categories',
'blogs_title_description' => 'Enter the Title of blog in en ,ar , es',
'title_description' => 'Enter the ID of the course (webinar) from https://www.yrreadybiz.com/admin/webinars?type=course , Or ID of the Bundle from https://www.yrreadybiz.com/admin/bundles',
'student_description' => 'Enter the ID of the student from https://www.yrreadybiz.com/admin/students',
'type_description' => 'Enter "Course" if the review is for a webinar. Enter "Bundle" if the review is for a bundle',
'status_description_two' => 'Enter either "pending" or "active". active value for Active and  pending value for Pending.',
'customer_id_description' => 'This customer Id can get it from products page Ex: https://www.yrreadybiz.com/admin/store/products',
'product_id_description' => 'This products Id can get it from students page Ex: https://www.yrreadybiz.com/admin/students',
'customer' => 'Customer ID',
'product' => 'Product ID',
'required' => 'Required',
'optional' => 'Optional',
'status_description' => 'Enter either "active" or "disable".active value for Active and disable value for Disacive.',
'rate_description' => 'Enter a numeric number be between 0 and 5.',
'comment_description' => 'Enter the testimonial text. There is no strict character limit, but keep it concise and relevant',
'job_itle_description' => 'Insert here the job title max (255)',
'user_name_description' => 'Insert here the user name max (255)',
'user_avatar_description' => 'Insert here url of the user avatar',
'job_title' => 'Job Title',
...
'upload_excel' => 'File To Import',
'Backend Iframe Height' => 'Backend Iframe Height',
'Frontend Iframe Height' => 'Frontend Iframe Height *EN*',
'Frontend Iframe Height gk' => 'Frontend Iframe Height *GK*',
'Frontend Iframe Height gr' => 'Frontend Iframe Height *GR*',
'iframe connection (back-end)' => 'Iframe Connection (Back-End)',
'iframe connection (front-end)' => 'Iframe Connection (Front-End) *EN*',
'iframe connection (front-end)en' => 'Iframe Connection (Front-End) *EN*',
'iframe connection (front-end)gk' => 'Iframe Connection (Front-End) *GK*',
'iframe connection (front-end)gr' => 'Iframe Connection (Front-End) *GR*',
'crm' => 'CRM',
'content' => 'Content',
'lists' => 'List',
'list' => 'List',
...
'enable_language_over_ip' => 'Enable Language Over IP',
'country' => 'Country',
'language' => 'Language',
'select_country' => 'Select a Country',
'select_language' => 'Select a Language',
'country_mappings' => 'Country Mappings',
'country_mappings_description' => 'Visitors from these countries will be shown a popup with a suggestion to view content in their local language.',
'create_mapping' => 'Create Mapping',
'create_mapping_description' => 'Country <-> Language: Select a Country and then pick a Language to be shown as a suggestion & redirection in the notification popup!',
'update_mapping_note' => 'To update a mapping, simply recreate the mapping.',
'existing_mappings' => 'Existing Mappings',
'no_mappings' => 'No mappings found.',
...
'action_type_description' => 'Redirect automatically or show a popup?' ,
'popup_text' => 'Popup Texts' ,
'popup_text_description' => 'Configure PopUp Title, Text & Buttons.' ,
'notification_title'    => 'Notification Title' ,
'notification_text'     => 'Notification Text' ,
'confirm_button_text'   => 'Confirm Button Text' ,
'cancel_button_text'    => 'Cancel Button Text' ,
'action_type_popup'     => 'Show a popup with choice' ,
'action_type_redirect'  => "Don't show popup, automatically redirect" ,
'contact_us' => 'Contact',
